...
**table of contents**
* [Linux常用命令一览](#Linux常用命令一览)
* [sed用法](https://gitdzreal93.github.io/linux/linux-sed.html)
* [awk用法](https://gitdzreal93.github.io/linux/linux-awk.html)
* [shell编程相关]()

# Linux常用命令一览

>（ tips:本文只会提到作者日常工作中运用到的命令，假如没有使用过，不确定用途的，不会记录在此~ 东西比较多比较杂，可以用 Ctrl+F 查询一下有没有相关命令，若没有的话，陆续会补充。 ）
...
```
附录：[硬链接和软连接的区别](https://blog.csdn.net/bobyuan888/article/details/78874913)
...
2. [dstat相关用法解读](https://www.cnblogs.com/lazyfang/p/7650010.html)
